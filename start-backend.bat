...
start "ShopFlow - API Gateway (8080)" cmd /c "cd backend\api-gateway && ..\mvnw.cmd spring-boot:run"
start "ShopFlow - Auth Service (8081)" cmd /c "cd backend\auth-service && ..\mvnw.cmd spring-boot:run"
start "ShopFlow - Product Catalog (8082)" cmd /c "cd backend\product-catalog-service && ..\mvnw.cmd spring-boot:run"
start "ShopFlow - Cart & Order (8083)" cmd /c "cd backend\cart-order-service && ..\mvnw.cmd spring-boot:run"
start "ShopFlow - Inventory Service (8084)" cmd /c "cd backend\inventory-service && ..\mvnw.cmd spring-boot:run"
start "ShopFlow - Notification Service (8085)" cmd /c "cd backend\notification-service && ..\mvnw.cmd spring-boot:run"

echo =====================================================================
echo All backend services launched in separate windows!
echo =====================================================================
pause
