...
export default function ProductDetailPage() {
  ...
  if (!product) return <div className="page" style={{ paddingTop: '96px', textAlign: 'center' }}><p>Product not found</p><Link to="/products" className="btn btn-primary" style={{ marginTop: '16px' }}>Back to Products</Link></div>;
